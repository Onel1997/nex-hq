...
export const designConceptSchema = z.object({
  ...
  milaeneTranslation: z.string().min(5).optional(),
  visualRestraint: z.string().min(5).optional(),
  symbolicAbstraction: z.string().min(5).optional(),
  editorialRestraint: z.string().min(5).optional(),
  symbolicAbstractionScore: flexOptionalPercentScore,
