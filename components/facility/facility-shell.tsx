    ...
    >
      {loading && !data ? (
        ...
        <div className="facility-error">
          ...
          <p className="facility-error-message">
            Unable to reach command systems. Retry sync or continue from Agent Wing.
          </p>
        </div>
      ) : data ? (
        <>
        ...
        <div className="facility-error">
          <p className="facility-error-title">Facility data unavailable</p>
          <p className="facility-error-message">
            Live telemetry is offline. Agent workspaces remain available.
          </p>
        </div>
      )}
    </div>
