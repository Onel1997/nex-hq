...
import { consumeImageStudioHandoff } from "@/lib/image/image-handoff-store";
  ...
  return (
    <section className="space-y-10">
      <div className="command-interface overflow-hidden px-10 py-14 sm:px-14 sm:py-16">
        ...
        {handoffSource ? (
          <p className="mb-4 rounded-lg border border-primary/20 bg-primary/5 px-4 py-2 text-sm text-muted-foreground">
            Loaded from Design Studio: <strong className="text-foreground">{handoffSource}</strong>
          </p>
        ) : null}
