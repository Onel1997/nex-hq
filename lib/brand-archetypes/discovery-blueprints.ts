...
export const MEDITERRANEAN_DISCOVERY_BLUEPRINTS: readonly ArchetypeCandidateBlueprint[] = [
  {
    ...
    jaw: "refined elegant jaw with soft masculine angle — subtle line without square mass, oversized flare, or aggressive geometry",
    cheekbones: "elegant medium cheekbones with soft under-cheek volume — defined but never exaggerated, never hollow fashion cut",
    nose: "narrow refined straight nose with soft tip and delicate nostrils — slim bridge, not wide",
    eyes: "warm expressive but relaxed almond brown eyes, softly open lids, slightly wider inter-eye spacing, calm friendly gaze",
    lips: "medium lips with gentle cupid bow and light philtrum definition — calm closed mouth",
    forehead: "medium-smooth forehead with soft temples and calm vertical height — never heavy brow shelf",
    eyebrowDensity: "slightly thicker natural brows with soft outer tails — never sparse pencil, never dense aggressive bars",
    ...
    haircut: "clean taper or soft textured curly crop with loose crown — natural streetwear, never perfect editorial hair",
    facialHair:
      "clean shave or subtle uneven slight stubble — refined light shadow, never full beard",
    bodyStructure:
      "lean athletic streetwear casting frame — normal proportions, healthy, wearable in oversized clothing — never bodybuilder",
    expression: "friendly calm — quiet confidence, authentic charisma; not smiling broadly, not intimidating, not runway severity",
    ...
    lightingDirection: "natural daylight with soft shadows — commercial fashion campaign energy, no cinematic grade",
    garmentDirection:
  ...
  },
  {
    ...
    jaw: "broader soft-masculine jaw with clear but subtle gonial presence — never oversized, never razor runway, never soft-luxury A refined",
    cheekbones: "defined medium-high cheekbones with lean midface — defined but not exaggerated sculpture",
    nose: "slightly wider natural nose with broader bridge and stronger tip character — distinct from A’s narrow refined nose",
    eyes: "expressive but relaxed deep-set dark brown eyes with slightly heavier lids — calm urban cool, not hunter aggression",
    lips: "medium lips with natural philtrum — calm closed mouth",
    forehead: "broader flatter forehead with natural brow shelf — more horizontal presence than A or C",
    eyebrowDensity: "slightly thicker natural low-set brows with continuous dark hair — never aggressive hunter bars",
    ...
    facialProportions:
      "broader soft-masculine proportions — wider mandible than A/C without oversized jaw mass; healthy lower-face balance",
    hairTexture: "dark dense coil-wave curls with tight natural texture — Maghrebi street-premium, not soft European waves",
    haircut: "short textured curls or natural curly crop with clean low fade — effortless streetwear, never perfect editorial hair",
    facialHair:
      "clean shave or well-kept slight stubble — never intimidating full beard, never stamped CGI density",
    bodyStructure:
      "lean athletic fashion build — normal healthy proportions wearable in oversized clothing — never bodybuilder",
    expression: "friendly calm urban cool — quiet confidence, authentic charisma; never aggressive, never hunter stare",
    stylingDirection:
    ...
    lightingDirection: "natural daylight with soft shadows — commercial campaign energy, never flat flash, never perfume lighting",
    garmentDirection:
  ...
  },
  {
    ...
    jaw: "soft tapered jaw with narrow chin and minimal gonial flare — soft masculine, never square athletic, never oversized",
    cheekbones: "defined medium-high cheekbones — never overly sculpted fashion cut",
    nose: "narrow characterful nose with slight natural bridge irregularity — artistic, not model-perfect straight A",
    eyes: "large expressive but relaxed hazel-to-warm-brown eyes with open lids — calm creative gaze",
    lips: "medium lips with delicate cupid bow — calm closed mouth",
    forehead: "higher open forehead with airy temples — more vertical forehead height than A/B",
    eyebrowDensity: "slightly thicker natural creative brows with soft outer break — never sparse pencil, never aggressive bars",
    earShape: "smaller close-set ears with delicate lobes — low projection, refined silhouette",
    hairline: "higher soft temple-receding creative hairline framing relaxed wavy medium or messy curls",
    facialProportions:
      "slim soft-masculine proportions — longer midface, narrower jaw relative to cheekbones, lighter overall facial mass than A/B/D",
    hairTexture: "medium chestnut-brown loose waves / effortless messy curls with lighter ends — not near-black dense crop",
    haircut: "relaxed wavy medium hair or effortless messy curls — natural contemporary streetwear, never perfect editorial hair",
    ...
    expression: "friendly calm contemporary presence — quiet confidence, authentic charisma; never feminine-coded, never intimidating",
    stylingDirection:
    ...
    lightingDirection: "natural daylight with soft shadows — commercial campaign energy, no beauty-retouch, no cinematic grade",
    garmentDirection:
  ...
  },
  {
    ...
    faceGeometry:
      "balanced rectangular Mediterranean head with warm horizontal presence — soft masculine ambassador silhouette, never movie-hero mass",
    jaw: "subtle-to-clear soft-masculine jaw with natural chin — never oversized square, never razor runway, never soft A taper twin",
    cheekbones: "defined supportive cheekbones — never overly sculpted perfume-campaign planes",
    nose: "strong natural aquiline-leaning bridge with clear character and fuller tip — hero nose, not narrow A or wide-flat B",
    eyes: "dark expressive but relaxed almond eyes with steady campaign spacing — warm quiet confidence, not hunter aggression",
    lips: "medium-to-fuller lips with soft volume — calm closed mouth",
    forehead: "broader natural forehead with balanced brow plane — more mass than C’s high open forehead",
    eyebrowDensity: "slightly thicker natural near-black brows with continuous coverage — never aggressive hunter bars",
    ...
    facialProportions:
      "premium campaign proportions — wider bizygomatic and mandibular width than A/C without oversized jaw; balanced vertical thirds",
    hairTexture: "thick near-black dense hair with coarse natural texture — Levantine density, not chestnut creative waves",
    haircut: "natural curly crop or short textured curls with clean taper — contemporary streetwear, never perfect editorial hair",
    facialHair:
      "clean shave or short even slight stubble denser along jawline — never intimidating full beard, never CGI stamp",
    bodyStructure:
      "lean athletic build with natural shoulder line — healthy, wearable in oversized clothing — never bodybuilder",
    expression: "friendly calm premium presence — quiet confidence, authentic charisma; never CEO hardness, never movie hero",
    stylingDirection:
    ...
    lightingDirection: "natural daylight with soft shadows — commercial campaign clarity, no orange skin, no perfume lighting",
    garmentDirection:
