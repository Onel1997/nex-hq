...
export const MEDITERRANEAN_DISCOVERY_BLUEPRINTS: readonly ArchetypeCandidateBlueprint[] = [
  {
    ...
    faceGeometry:
      "elegant soft oval face with reduced facial width — smooth oval silhouette, gently rounded temples, refined soft chin tip; NEVER rectangular, NEVER brother to B/C/D",
    jaw: "natural medium soft jaw with soft masculine angle — reduced width and sharpness, softer lower face, without square mass or aggressive geometry",
    ...
    eyes: "relaxed open warm almond brown eyes, soft lids, slightly wider inter-eye spacing, calm friendly approachable gaze",
    lips: "natural medium lips with gentle cupid bow — approachable neutral mouth",
    forehead: "medium-smooth forehead with soft temples and calm vertical height — never heavy brow shelf",
    eyebrowDensity: "balanced medium natural brows with soft outer tails — never sparse pencil, never dense heavy bars",
    ...
    facialProportions:
      "softer commercial vertical thirds with youthful cheek volume; narrow-to-medium facial width; softer lower face than prior casting",
    hairTexture: "dark chocolate-brown soft waves / light curls with lived-in density and fine-to-medium strands",
    haircut: "short textured curls, soft textured curly crop, or clean soft taper — cleaner contemporary streetwear, never long editorial waves",
    facialHair:
    ...
    diversitySampling: {
      ...
      slotDiversityInstruction:
        "Slot A must read as a Spanish/Iberian commercial soft-luxury streetwear face — maximum distance from Maghrebi B, Greek/Balkan C, and Levantine D. Different skull, jaw, nose template, and eye spacing from all other slots.",
    },
    fashionCasting: {
      ...
      facialCharacter:
        "softer commercial Mediterranean identity — elegant oval, defined but subtle jaw, softer cheekbones, expressive warm eyes, naturally thick brows — naturally photogenic not striking",
      memorabilityCue: "soft commercial face — “I want to dress like him” / “naturally belongs in Milaene” — not unreal fashion model, not a Levantine D twin",
  ...
  },
  {
    ...
    faceGeometry:
      "longer soft-masculine subtle rectangular face with clear vertical planes and warmer lower third — NEVER oval like A, NEVER triangular like C — reduced facial width vs prior athletic casting",
    jaw: "broader-than-A soft-masculine natural medium jaw with subtle gonial presence — reduced sharpness, never oversized, never razor runway, never soft-luxury A twin",
    cheekbones: "softer medium cheekbones with youthful volume — never exaggerated sculpture, never hollow fashion cut",
    nose: "slightly wider natural nose with broader bridge and stronger tip character — distinct from A’s narrow refined nose",
    eyes: "relaxed open deep-set dark brown eyes with soft lids — warmer urban calm, not hunter aggression",
    lips: "natural medium lips with natural philtrum — approachable neutral mouth",
    forehead: "broader flatter forehead with natural brow plane — never heavy brow shelf",
    eyebrowDensity: "balanced medium-dense natural low-set brows — never aggressive hunter bars, never heavy brow mass",
    earShape: "slightly larger projected ears with clearer helix definition — more athletic silhouette",
    hairline: "lower denser hairline with clean taper / low fade edge supporting short textured curls",
    facialProportions:
      "soft-masculine proportions — wider mandible than A/C without oversized jaw mass; reduced facial width for commercial relatability; softer lower face",
    hairTexture: "dark dense coil-wave curls with tight natural texture — Maghrebi street-premium, not soft European waves",
    haircut: "short textured curls or cropped curly crop with clean low fade — cleaner contemporary streetwear, never long editorial waves",
    facialHair:
    ...
    diversitySampling: {
      ...
      chinShape: "firmer soft-square chin with clear menton — athletic but not intimidating, no soft rounded A tip",
      ...
      slotDiversityInstruction:
        "Slot B must read as a Maghrebi North African commercial street-premium face — maximum biological distance from Spanish A, Greek/Balkan C, and Levantine D. Different skull length, jaw width, nose width, and brow angle from all other slots.",
    },
    fashionCasting: {
      ...
      facialCharacter:
        "softer broader masculine presence, wider nose, athletic facial proportions — urban commercial identity with expressive warm eyes and naturally thick brows — not Soft Luxury’s brother, not Levantine D twin",
  ...
  },
  {
    ...
    jaw: "soft tapered natural medium jaw with narrow chin and minimal gonial flare — softer lower face, never square athletic, never oversized",
    cheekbones: "softer youthful cheek volume — never overly sculpted fashion cut",
    nose: "narrow characterful nose with slight natural bridge irregularity — artistic, not model-perfect straight A",
    eyes: "large relaxed open hazel-to-warm-brown eyes with soft lids — warmer creative approachable gaze",
    lips: "natural medium lips with delicate cupid bow — approachable neutral mouth",
    forehead: "higher open forehead with airy temples — more vertical forehead height than A/B",
    eyebrowDensity: "balanced medium natural creative brows with soft outer break — never sparse pencil, never heavy bars",
    earShape: "smaller close-set ears with delicate lobes — low projection, refined silhouette",
    hairline: "higher soft temple-receding creative hairline framing short textured or occasionally medium waves",
    facialProportions:
      "slim soft-masculine proportions — longer midface, narrower jaw relative to cheeks, lighter facial mass than A/B/D — reduced facial width",
    hairTexture: "medium chestnut-brown loose waves / short messy curls with lighter ends — not near-black dense crop",
    haircut: "short natural waves or cropped messy curls preferred; medium wavy hair only occasionally for diversity — never long editorial male-model waves",
    ...
    diversitySampling: {
      ...
      slotDiversityInstruction:
        "Slot C must read as a Greek/Balkan commercial creative streetwear face — maximum biological distance from Spanish A, Maghrebi B, and Levantine D. Different head shape, chin taper, eye spacing, and nose tip from all other slots.",
    },
    fashionCasting: {
      ...
      facialCharacter:
        "slimmer artistic facial structure, expressive warm relaxed eyes, naturally thick creative brows, naturally memorable asymmetry — not a recolored Soft Luxury, not Levantine D twin",
  ...
  },
  {
    ...
    faceGeometry:
      "balanced subtle rectangular Mediterranean head with warm horizontal presence — softer commercial ambassador silhouette, reduced facial width, never movie-hero mass",
    jaw: "natural medium soft-masculine jaw with soft chin — reduced width and sharpness, never oversized square, never razor runway, never soft A taper twin",
    cheekbones: "softer youthful supportive cheeks — reduced prominence, never perfume-campaign planes",
    nose: "natural aquiline-leaning bridge with clear character and fuller tip — Levantine character nose, not narrow A or wide-flat B",
    eyes: "dark relaxed open almond eyes with steady commercial spacing — warm quiet youthful confidence, not hunter aggression",
    lips: "natural medium-to-fuller lips with soft volume — approachable neutral mouth",
    forehead: "broader natural forehead with balanced brow plane — never heavy brow shelf mass",
    eyebrowDensity: "balanced medium-dense near-black brows with continuous coverage — never aggressive hunter bars, never heavy brow mass",
    earShape: "stronger lobed ears with clearer antihelix — moderate projection supporting head width",
    hairline: "dense low near-black hairline with natural curly / textured crop — no soft temple recession like C",
    facialProportions:
      "commercial premium proportions — wider than A/C without oversized jaw; reduced facial width for relatability; softer lower face; balanced vertical thirds",
    hairTexture: "thick near-black dense hair with coarse natural texture — Levantine density, not chestnut creative waves",
    haircut: "cropped curly crop or short textured curls with clean soft taper — cleaner contemporary streetwear, never long editorial waves",
    facialHair:
    ...
    diversitySampling: {
      ...
      headShape: "balanced rectangular Levantine head — widest cranial footprint of the cast, slightly moderated width",
      skullProportions: "broader cranial base with warm frontal width — Levantine commercial skull, not Iberian oval or Hellenic slim",
      chinShape: "natural broader chin with optional soft dimple — highest chin mass of the four, never superhero square",
      eyeSpacing: "balanced commercial eye spacing — between A’s open set and B’s close set",
      eyebrowAngle: "straight dense near-horizontal brows — continuous brow shelf, never aggressive hunter bars",
      noseBridge: "natural aquiline-leaning high bridge — Levantine character nasal root",
      noseWidth: "medium-strong alar width supporting Levantine bridge — not Maghrebi widest, not Iberian narrowest",
      ...
      slotDiversityInstruction:
        "Slot D must read as a Lebanese/Levantine flagship commercial streetwear face — maximum biological distance from Spanish A, Maghrebi B, and Greek/Balkan C. Different skull width, chin mass, brow shelf, and aquiline nose from all other slots.",
    },
    fashionCasting: {
      ...
      facialCharacter:
        "warm Levantine commercial presence — youthful soft masculine bone structure, defined but subtle jaw, softer cheekbones, expressive warm eyes, naturally thick brows, textured dark hair — premium everyday attractiveness, not generic stock, not unreal fashion model, NOT a locked prior Candidate D identity",
