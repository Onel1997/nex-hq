export const ceo = {
  ...
  interface: {
    ...
    missionsLabel: "Executive Missions",
  ...
  intelligence: {
    ...
    title: "Milaene Business Pulse",
    overview: "CEO Overview",
    revenue: "Revenue",
    orders: "Orders",
    bestSeller: "Best Seller",
    topCategory: "Category Leader",
    productsActive: "Products Active",
    recommendations: "Strategic Recommendations",
    agentStatus: "Agent Status",
    companySignals: "Live Company Signals",
    ceoTasks: "CEO Tasks",
    marketPrint: "MarketPrint CEO Intelligence",
    premiumProducts: "Premium Products",
    campaignProducts: "Campaign Products",
    embroidery: "Embroidery Opportunities",
    highCategories: "High-Performing Categories",
    limitations: "Production Limitations",
    noDecisions: "No CEO decisions yet — delegate a goal to begin.",
  ...
  panels: {
    ...
    signals: "signals",
    businessSignals: "{count} Business Signals",
    departments: "departments",
    departmentsActive: "{count} Departments Active",
    totalTasks: "tasks",
    delegated: "delegated",
    premiumProductsMeta: "{count} Premium Products",
    reportPending: "Final report pending",
  ...
  missions: {
    summerDrop: "Develop Summer Drop",
    nextCollection: "Plan Next Collection",
    launchCampaign: "Launch New Campaign",
    opportunities: "Review Strategic Opportunities",
    trends2026: "Analyze 2026 Trends",
    differentiateRepresent: "Competitive Differentiation",
  },
  heroStatus: {
    label: "CEO Status",
    executiveMode: "Executive Mode Active",
    briefingMode: "Strategy Briefing Active",
    agentsOnline: "{count} Agents Online",
    delegatedTasks: "{count} Delegated Tasks",
