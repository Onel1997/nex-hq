export const research = {
  ...
  interface: {
    ...
    collection: {
      ...
      hero: "Hero",
      score: "Kollektions-Score",
      recommendation: "Empfehlung",
      heroProduct: "Hero-Produkt",
      retail: "Retail",
      production: "Produktion",
      confidence: "Confidence",
      dropStrategy: "Drop-Strategie",
      colorDirection: "Farbrichtung",
      campaignTheme: "Kampagnen-Theme",
      imagePrompt: "Image-Prompt Kollektion",
      arc: "Collection Arc",
      emotionalStory: "Emotional Story",
      relationshipGraph: "Relationship Graph",
      dnaRanking: "DNA Ranking",
      ceoAnalysis: "CEO Analysis",
      strongestProduct: "Stärkstes Produkt",
      weakestProduct: "Schwächstes Produkt",
      launchOrder: "Launch-Reihenfolge",
      productionRisk: "Produktionsrisiko",
      commercialConfidence: "Commercial Confidence",
      adPotential: "Ad Potential",
      heroBadge: "Hero Piece",
      supports: "unterstützt",
      heroScore: "Hero Score",
      commercialScore: "Commercial Score",
      campaignPotential: "Campaign Potential",
      whyHero: "Warum dies der Hero ist",
      visualStrength: "Visuelle Stärke",
      emotionalStrength: "Emotionale Stärke",
    ...
    designConcept: {
      title: "Konzept",
      creativeApproach: "Kreativer Ansatz",
      product: "Produkt",
      color: "Farbe",
      printArea: "Printfläche",
      printPosition: "Printfläche",
      styleDirection: "Stilrichtung",
      emotion: "Emotion",
      visualConcept: "Visuelles Konzept",
      designDescription: "Design-Beschreibung",
      message: "Botschaft / Text",
      ...
      placementDimensions: "Platzierung / Maße",
      garmentInspiration: "Garment-Inspiration",
      brandInspiration: "Marken-Inspiration",
      productionDifficulty: "Produktionsaufwand",
      visualReferences: "Visuelle Referenzen",
      production: "Produktion",
      inspiration: "Inspiration",
      artDirection: "Art Direction",
      exactComposition: "Komposition",
      graphicElements: "Elemente",
      elementCount: "Elementanzahl",
      layoutDescription: "Layout",
      visualHierarchy: "Visuelle Hierarchie",
      colorBreakdown: "Farbaufteilung",
      materialEffects: "Material-Effekte",
      negativeSpaceUsage: "Negativraum",
      designInstructions: "Designer-Anweisungen",
      mockupDescription: "Mockup-Beschreibung",
      ...
      textureIntensity: "Texturintensität",
      visualWeight: "Visuelles Gewicht",
      balance: "Balance",
      alignment: "Ausrichtung",
      focalPoint: "Brennpunkt",
      edgeTreatment: "Kantenbehandlung",
      milaeneDna: "Milaene DNA Analyse",
      dnaScore: "DNA Score",
      dnaMatches: "Matches",
      dnaConflicts: "Konflikte",
      whyFitsMilaene: "Warum dies zu Milaene passt",
      collectionRole: "Kollektionsrolle",
      repeatabilityScore: "Wiederholbarkeit",
      imagePromptCore: "Image-Prompt Kern",
      supportsDesignId: "Unterstützt Design",
      emotionalNarrative: "Emotionale Narrative",
      emotionalKeyword: "Emotionales Keyword",
      storyPosition: "Story-Position",
      relationshipReason: "Beziehung zur Kollektion",
      commercialScore: "Commercial Score",
      campaignPotential: "Campaign Potential",
      heroScore: "Hero Score",
    },
