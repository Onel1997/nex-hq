...
export interface DeterministicJobRepository {
  ...
  list(scope: WorkspaceScope, filters?: { projectId?: string }): Promise<DeterministicImageJob[]>;
  ...
  markUnknown(scope: WorkspaceScope, id: string, reason: string, now: string): Promise<DeterministicImageJob>;
}
