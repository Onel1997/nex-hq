...
/** Bumped in 2.2L for strong A/B/C/D hair + face-geometry casting diversity (keeps 2.2K softer quality). */
export const SLOT_BLUEPRINT_VERSION = "2.2L.0" as const;
...
const SLOT_A_POOLS = pools({
  ...
  faceGeometry: [
    "softer oval / slightly rectangular Iberian silhouette with gently rounded temples",
    "elongated oval cranial outline with refined Iberian length — still soft oval family",
    "slightly rectangular soft-luxury face with calm vertical balance",
    "soft oval-to-slight-rectangle with refined chin tip — never wider-upper creative",
    "softly angular oval with light cheek-plane definition — Iberian commercial, never Maghrebi elongated",
  ],
  forehead: [
  ...
  noseBridge: [
    "medium straight Iberian bridge with soft root",
    "medium-width straight Iberian bridge",
    "subtle soft bridge with calm commercial character — never aquiline hero",
    "broader soft bridge with gentle root mass — still Iberian, not Maghrebi widest",
    "balanced medium Iberian bridge with soft vertical line",
  ],
  noseWidth: [
    "medium alar width — commercial Iberian",
    "medium-width soft alar base",
    "medium refined width — not delicate-narrow creative twin",
    "soft medium alar span within Iberian premium",
  ...
  hairline: [
    "straight natural soft-luxury hairline supporting short crop",
    "soft M-shape hairline with gentle temple notches under short taper",
    "higher corner hairline with open temples — short textured crop",
    "rounded natural hairline with calm density at temples — never medium-wave framing",
    "uneven natural hairline with lived-in temple variation under short curls",
  ],
  haircut: [
    "short textured crop — low-maintenance streetwear",
    "short curls with clean soft taper",
    "clean taper fade with short textured top — NO medium waves",
    "short curly crop with natural crown — never medium-long waves",
    "low-maintenance short streetwear crop — never middle-part waves",
  ],
  beardPattern: [
...
const SLOT_B_POOLS = pools({
  ...
  facialRatioVariant: [
    "narrower elongated proportions — longer midface, more compact jaw",
    "longer vertical facial balance with compact lower third",
    "elongated soft-masculine ratios with reduced mandibular width",
    "narrower elongated ratios — never soft oval Iberian, never wider-upper creative",
  ],
  faceGeometry: [
    "narrower elongated Maghrebi face with clear vertical planes",
    "elongated soft-masculine outline with warmer compact lower third",
    "longer cranial elongated silhouette — never soft oval",
    "narrower elongated face with firm vertical length — compact jaw cue",
  ],
  forehead: [
  ...
  eyebrows: [
    "medium flat-to-low brows with continuous dark hair — different brow shape from Iberian arch",
    "flat medium urban brows — never soft arched Iberian",
    "low straight soft-masculine brow with medium coverage — never heavy hunter bars",
  ],
  eyeShape: [
  ...
  jaw: [
    "more compact soft-masculine jaw with subtler gonial angle — less pronounced",
    "compact jaw with softer chin mass readiness — never oversized",
    "more compact mandible with urban soft-masculine angle",
    "clearer gonial presence than soft luxury but more compact overall — never razor runway",
  ],
  chin: [
    "more compact soft chin with clear menton — not intimidating",
    "compact soft-square chin — no soft rounded tip twin of A",
    "firm compact chin with clear projection — never superhero block",
    "stronger menton mass on a more compact jaw footprint",
  ],
  cheekbones: [
  ...
  hairline: [
    "cleaner denser hairline with tight temple fade / buzz-adjacent edge",
    "dense low hairline supporting very short crop or tight short curls",
    "tight temple-fade hairline with urban precision — never medium-wave framing",
    "lower dense Maghrebi hairline — never soft temple recession, never loose long curls",
  ],
  haircut: [
    "very short crop / buzz-adjacent texture — Maghrebi street premium",
    "tight short curls with clean low fade — cleaner hairline",
    "buzz-adjacent short textured crop — NO loose long curls",
    "tight short curl fade — never medium-length waves, never middle-part waves",
  ],
  beardPattern: [
...
const SLOT_C_POOLS = pools({
  ...
  facialRatioVariant: [
    "slightly wider upper face with softer lower face — creative commercial",
    "wider upper-third / softer lower-third creative balance",
    "open midface with narrower jaw relative to upper face",
    "airy vertical forehead-to-chin creative balance with wider upper presence",
  ],
  faceGeometry: [
    "slightly wider upper face with softer lower face — open midface",
    "wider-upper creative outline with soft lower taper",
    "creative face with distinct wider eye-spacing readiness — never oval soft luxury, never elongated Maghrebi",
    "wider upper-face silhouette with soft cheek structure — never balanced angular Levantine",
  ],
  forehead: [
  ...
  cheekbones: [
    "different softer cheek structure with gentle under-cheek volume",
    "creative soft cheek support — never hollow fashion cut, never A twin",
    "softer creative cheekbones with open wider midface",
  ],
  lips: [
  ...
  hairline: [
    "higher soft temple-receding creative hairline framing medium relaxed waves",
    "soft creative hairline framing medium-length waves — ONLY longer/wavier lane",
    "higher open temples with gentle recession cue under medium waves",
    "airy creative hairline — never dense low hero crop, never buzz-adjacent B",
  ],
  haircut: [
    "medium-length relaxed waves — creative streetwear lane (ONLY slot)",
    "medium loose waves with soft crown — strongly preferred longer/wavier hair",
    "relaxed medium wavy creative cut — never short buzz twin of B",
    "medium-length lived-in waves — never short crop twin of A/D",
  ],
  beardPattern: [
...
const SLOT_D_POOLS = pools({
  ...
  facialRatioVariant: [
    "balanced narrow-to-medium proportions with subtle angularity",
    "balanced vertical thirds with warm lower-face presence — never superhero mass",
    "narrow-to-medium commercial width with soft horizontal presence",
    "flagship ambassador ratios with distinct nose tip / lips / chin relationship",
  ],
  faceGeometry: [
    "balanced narrow-to-medium Levantine face with subtle angularity",
    "balanced commercial silhouette with soft angular cue — never soft oval Iberian",
    "narrow-to-medium ambassador head — never elongated Maghrebi, never wider-upper creative",
    "warm balanced angular Levantine face — never movie-hero mass",
  ],
  forehead: [
  ...
  hairline: [
    "dense low near-black hairline with short messy curl / soft taper support",
    "dense low Levantine hairline — no soft temple recession, no medium-wave framing",
    "thick near-black low hairline with commercial short texture",
    "low dense Levantine hairline framing short messy curls or soft taper — NO long editorial",
  ],
  haircut: [
    "short messy curls — Levantine commercial streetwear",
    "short natural textured hair with soft taper",
    "soft taper with short textured top — never long editorial hair",
    "short messy curly crop — never medium-length waves, never middle-part wavy twin of C",
  ],
  beardPattern: [
...
export const MEDITERRANEAN_SLOT_BLUEPRINTS: readonly SlotBlueprint[] = [
  mediterraneanLane({
    ...
    facialProportionFamily: "softer oval / slightly rectangular narrow-to-medium midface family — reduced facial width",
    hairTextureFamily: "dark chocolate-brown short textured crop/taper family — NO medium-long waves",
    ...
    crossSlotExclusions: [
      "Maghrebi elongated skull",
      "Greek/Balkan wider-upper creative head",
      "Levantine balanced angular aquiline skull",
      "very short buzz-adjacent fade",
      "medium-length relaxed waves",
  ...
  mediterraneanLane({
    ...
    facialProportionFamily: "narrower elongated soft-masculine family — more compact jaw — reduced facial width",
    hairTextureFamily: "dark dense tight coil / very short crop family — Maghrebi street-premium",
    ...
    crossSlotExclusions: [
      "Spanish Iberian soft oval / slight rectangle",
      "Greek/Balkan wider-upper creative",
      "Levantine balanced angular aquiline",
      "medium-length relaxed waves",
      "short Iberian textured crop twin",
      "soft luxury medium Iberian nose",
    ],
  ...
  mediterraneanLane({
    ...
    facialProportionFamily: "slightly wider upper face / softer lower face creative midface family",
    hairTextureFamily: "medium chestnut-brown medium-length relaxed waves — ONLY longer/wavier lane",
    ...
    crossSlotExclusions: [
      "Spanish Iberian soft oval / slight rectangle",
      "Maghrebi narrower elongated skull",
      "Levantine balanced angular aquiline",
      "very short buzz-adjacent fade",
      "short Iberian textured crop",
      "short messy Levantine curls",
  ...
  mediterraneanLane({
    ...
    facialProportionFamily: "balanced narrow-to-medium subtle angular commercial streetwear casting family — never oversized jaw",
    hairTextureFamily: "thick near-black short messy curls / soft taper texture — Levantine casting — NO long editorial",
    ...
    crossSlotExclusions: [
      "Spanish Iberian soft oval / slight rectangle",
      "Maghrebi narrower elongated street skull",
      "Greek/Balkan wider-upper creative",
      "medium-length relaxed waves",
      "very short buzz-adjacent fade",
      "soft luxury Iberian jaw twin",
      "Candidate D anatomy template applied to A/B/C",
    ],
