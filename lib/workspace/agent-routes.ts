...
export const VIDEO_STUDIO_ROUTE = "/agents/video";
...
export function isVideoStudioPath(pathname: string): boolean {
  return (
    pathname === VIDEO_STUDIO_ROUTE ||
    pathname.startsWith(`${VIDEO_STUDIO_ROUTE}/`)
  );
}
