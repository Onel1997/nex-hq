...
import { deriveLabSnapshots } from "@/lib/workspace/derive-lab-state";
import { getAgentEvents } from "@/lib/workspace/events";
import type {
  LabInspectorData,
  LabReportDetail,
  LabTaskSnapshot,
...
import { buildLabMetrics } from "@/lib/workspace/lab-intelligence";
